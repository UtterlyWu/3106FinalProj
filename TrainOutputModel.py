...
model = OutputModel(num_classes).to(device)
...
for epoch in range(epochs):
    ...
    torch.save(model.state_dict(), f"outputmodels/outputM_E{epoch+1}_L{(total_val_loss / len(validation_dataloader)):.3f}.pth")
